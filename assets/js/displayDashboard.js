...
function displayDashboard() {
    ...
    .then(function(data){
        ...
        movieDashboardEl.innerHTML += `<div class="column poster-tile is-2" style="width:180px"><img src="https://image.tmdb.org/t/p/original${data.results[i].poster_path}" placeholder="${data.results[i].title}" id="${posterID}" style="width:180px"/></div>`
        }
    })
}
